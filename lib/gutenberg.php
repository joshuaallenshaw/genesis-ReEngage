...
add_action( 'wp_enqueue_scripts', 'genesis_reengage_enqueue_gutenberg_frontend_styles' );
/**
 * Enqueues Gutenberg front-end styles.
 *
 * @since 2.7.0
 */
function genesis_reengage_enqueue_gutenberg_frontend_styles() {
	wp_enqueue_style(
		genesis_get_theme_handle() . '-gutenberg',
		get_stylesheet_directory_uri() . '/lib/css/gutenberg-front.css',
...
add_action( 'enqueue_block_editor_assets', 'genesis_reengage_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 2.7.0
 */
function genesis_reengage_block_editor_styles() {
...
add_filter( 'body_class', 'genesis_reengage_blocks_body_classes' );
/**
 ...
 */
function genesis_reengage_blocks_body_classes( $classes ) {
...
add_editor_style( '/lib/css/gutenberg-editor.css' );
...
$genesis_reengage_appearance = genesis_get_config( 'appearance' );

// Adds support for editor font sizes.
add_theme_support( 'editor-font-sizes', $genesis_reengage_appearance['editor-font-sizes'] );

// Adds support for editor color palette.
add_theme_support( 'editor-color-palette', $genesis_reengage_appearance['editor-color-palette'] );

require_once get_stylesheet_directory() . '/lib/gutenberg-inline-styles.php';

add_action( 'after_setup_theme', 'genesis_reengage_content_width', 0 );
/**
 * Set content width to match the “wide” Gutenberg block width.
 */
function genesis_reengage_content_width() {
	$appearance = genesis_get_config( 'appearance' );

	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- See https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/924
	$GLOBALS['content_width'] = apply_filters( 'genesis_reengage_content_width', $appearance['content-width'] );

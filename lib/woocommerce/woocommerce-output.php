 ...
 * Genesis ReEngage.
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the Genesis ReEngage Theme.
 *
...
add_filter( 'woocommerce_enqueue_styles', 'genesis_reengage_woocommerce_styles' );
/**
 ...
 */
function genesis_reengage_woocommerce_styles( $enqueue_styles ) {
	$enqueue_styles[ genesis_get_theme_handle() . '-woocommerce-styles' ] = [
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/genesis-reengage-woocommerce.css',
		'deps'    => '',
...
add_action( 'wp_enqueue_scripts', 'genesis_reengage_woocommerce_css' );
/**
 ...
 */
function genesis_reengage_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'genesis_reengage_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'genesis_reengage_accent_color', $appearance['default-colors']['accent'] );
